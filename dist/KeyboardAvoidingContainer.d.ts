...
export declare const KeyboardAvoidingContainer: (<
  TScrollViewProps extends ScrollViewProps
>({
  stickyFooter,
  containerStyle,
  ...
  stickyFooterRef,
  stickyFooterProps,
}: KeyboardAvoidingContainerProps<TScrollViewProps>) => JSX.Element) &
  Pick<
    React.NamedExoticComponent<KeyboardAvoidingContainerProps<ScrollViewProps>>,
    'displayName'
  >
export declare function useKeyboardAvoidingContainerProps<
  TScrollViewProps extends ScrollViewProps
>({
  stickyFooter,
  containerStyle,
