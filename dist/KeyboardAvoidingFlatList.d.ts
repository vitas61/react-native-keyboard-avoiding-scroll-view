...
export interface KeyboardAvoidingFlatListProps<
  TItem extends {
    id: string
  }
> extends FlatListProps<TItem>, ExternalKeyboardAvoidingContainerProps {}
export declare const KeyboardAvoidingFlatList: (<
  TItem extends {
    id: string
  }
>(
  props: KeyboardAvoidingFlatListProps<TItem>,
) => JSX.Element) &
  Pick<
    React.ComponentType<
      KeyboardAvoidingFlatListProps<{
        id: string
      }>
    >,
